...
import { fetchTransactionsByVendor } from '../../../state/vendor/TransactionSlice';
...
export default function TransactionTable() {
  ...
  React.useEffect(() => {
    dispatch(fetchTransactionsByVendor(localStorage.getItem('jwt') || ''));
  }, []);
      ...
      <Table sx={{ minWidth: 700 }} aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell >Customer Detail</StyledTableCell>
