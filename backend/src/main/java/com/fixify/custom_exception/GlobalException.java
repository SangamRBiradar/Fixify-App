...
public class GlobalException {
	...
	public ResponseEntity<ErrorDetails> serviceExceptionHandler(ServiceException ue, WebRequest req) {
	...
	public ResponseEntity<ErrorDetails> handleVendorException(VendorException ex, WebRequest req) {
